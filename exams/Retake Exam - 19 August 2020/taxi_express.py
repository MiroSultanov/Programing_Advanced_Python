...
# •	If the taxi can drive the customer to his/her destination, he does and you must add the time passed to drive the customer to his/her destination (the value of the
# current customer) to the total time. Remove both the customer and the taxi.
